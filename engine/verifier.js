...
class DataVerifier {
    ...
    async quickVerification(devicePath, progressCallback) {
        try {
            ...
            const chunkSize = Math.min(sampleSize / samples, 64 * 1024); // Max 64KB per sample
            ...
            for (let i = 0; i < samples; i++) {
                ...
                const position = Math.floor(Math.random() * (size - chunkSize));
            ...
            throw new Error(`Failed during quick verification: ${error.message}`);
        }
    }
    ...
    async thoroughVerification(devicePath, progressCallback) {
        try {
            ...
            throw new Error(`Failed during thorough verification: ${error.message}`);
        }
    }
    ...
    async forensicVerification(devicePath, progressCallback) {
        try {
            ...
            throw new Error(`Failed during forensic verification: ${error.message}`);
        }
    }
    ...
    async militaryVerification(devicePath, progressCallback) {
        try {
            ...
            throw new Error(`Failed during military verification: ${error.message}`);
        }
    }
    ...
    async quantumVerification(devicePath, progressCallback) {
        try {
            ...
            throw new Error(`Failed during quantum verification: ${error.message}`);
        }
    }
